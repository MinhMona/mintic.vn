                        ...
                        <form runat="server" class="login-form">
                            ...
                            <div class="row">
                                <div class="input-field col s12 align-center">
                                     <span class="img logo-login">
                                        <a href="/"><img src="/App_Themes/CSSMINTIC/images/logo.png" alt="logo"></a></span>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <a onclick="GetPass()" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12">Khôi phục mật khẩu</a>
                                </div>
                            </div>
                            <div class="row">

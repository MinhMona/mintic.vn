...
namespace NHST.manager
{
    public partial class Report_OrderNew : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            StrExport.Append("      <th><strong>Tiền chênh lệch</strong></th>");
            ...
            foreach (var item in la)
            {
                ...
                StrExport.Append("      <td>" + string.Format("{0:N0}", Convert.ToDouble(item.PriceVND) - Convert.ToDouble(item.TotalPriceReal)) + "</td>");

            ...
            if (package != null)
            {
                ...
                else
                {
                    ...
                    if (mainorder != null)
                    {
                        ...
                        double PriceVND = Math.Round(Convert.ToDouble(mainorder.PriceVND), 0);

                        double TotalPriceVND = FeeShipCN + FeeBuyPro + FeeWeight + IsCheckProductPrice + IsPackedPrice + IsFastDeliveryPrice + PriceVND + InsuranceMoney;
                                        ...
                                        if (acc != null)
                                        {
                                            ...
                                            if (setNoti.IsSendEmailUser == true)
                                            {
                                                try
                                                {
                                                    ...
                                                    "Thông báo tại Mintic Logistics.", "Hàng của đơn hàng " + mainorder.ID + " Hàng về kho TQ.", "");
                                                }
                                                catch { }
                                            }
                                        }
                            ...
                            if (sm != null)
                            {
                                ...
                                if (Convert.ToInt32(sm.MainOrderID) > 0)
                                {
                                    ...
                                    if (main != null)
                                    {
                                        ...
                                        {
                                            var warehouse = WarehouseFromController.GetByID(main.FromPlace ?? 0);

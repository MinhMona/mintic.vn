...
namespace NHST.manager
{
    public partial class OrderDetail : System.Web.UI.Page
    {
                ...
                if (o != null)
                {
                    ...
                    if (obj_user != null)
                    {
                        ...
                        else if (RoleID == 6)
                        {
                            ...
                            pHHCYN.Enabled = false;
                            pHHVND.Enabled = false;
                        ...
                        double UnitPrice = 0;
                        if (o.UnitPrice != null)
                            UnitPrice = Convert.ToDouble(o.UnitPrice);
                        pUnitPrice.Text = string.Format("{0:N0}", Convert.ToDouble(UnitPrice));
                        ...
                        if (smallpackages.Count > 0)
                        {
                            foreach (var s in smallpackages)
                            {
                                ...
                                spsList.Append("                    <input class=\"transactionWeight\" type=\"text\" value=\"" + pDai + " x " + pRong + " x " + pCao + "\"></td>");
                                spsList.Append("                <td>");
                        ...
                        if (ischeckmvd == true)
                        {
                            ...
                            if (status == 1)
                            {
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGmail("admin@mintic.vn", "monamedia",
                                        accmuahan.Email, "Thông báo tại Mintic Logistics.", "Đơn hàng " + o.ID + " đã được hủy.", "");
                                    }
                                    catch { }
                                }
                            }
                            else
                            {
                                ...
                                if (o.PercentDeposit.ToFloat(0) > 0)
                                    PercentDeposit = Math.Round(Convert.ToDouble(o.PercentDeposit), 0);
                                ...
                                if (o.Status == 0)
                                {
                                    if (Current_Percent != PercentService)
                                    {
                                        ...
                                        double TotalPrice = Math.Round(PriceVND + FeeBuyPro, 0);

                                        AmountDeposit = Math.Round((TotalPrice * PercentDeposit) / 100, 0);
                                    }
                                }
                                ...
                                double CurrentCNYVN = Math.Round(Convert.ToDouble(o.CurrentCNYVN), 0);
                                double TotalPriceRealCYN = Math.Round(Convert.ToDouble(rTotalPriceRealCYN.Text), 2);
                                double TotalPriceReal = Math.Round(TotalPriceRealCYN * CurrentCNYVN, 0);
                                double CurrentUnitPrice = Math.Round(Convert.ToDouble(o.UnitPrice), 0);
                                double UnitPrice = Math.Round(Convert.ToDouble(pUnitPrice.Text), 0);

                                if (CurrentUnitPrice != UnitPrice)
                                {
                                    FeeWeight = Math.Round(OrderWeight * UnitPrice, 0);
                                    HistoryOrderChangeController.Insert(o.ID, obj_user.ID, obj_user.Username, obj_user.Username +
                                    " đã đổi đơn giá vận chuyển của đơn hàng ID là: " + o.ID + ", từ " + string.Format("{0:N0}", CurrentUnitPrice) + " sang " + string.Format("{0:N0}", UnitPrice), 2, currentDate);

                                    MainOrderController.UpdateUnitPrice(o.ID, UnitPrice);
                                }
                                ...
                                if (InsetBarcode == 1)
                                {
                                    if (currentstt < 6)
                                    {
                                        ...
                                        if (setNoti.IsSendEmailUser == true)
                                        {
                                            ...
                                            {
                                                PJUtils.SendMailGmail("admin@mintic.vn", "monamedia",
                                                accmuahan.Email, "Thông báo tại Mintic Logistics.", "Đơn hàng " + o.ID + " đã được Shop phát hàng.", "");
                                            }
                                            catch { }
                                        }
                                    }
                                ...
                                if (status != currentstt)
                                {
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        ...
                                        {
                                            PJUtils.SendMailGmail("admin@mintic.vn", "monamedia",
                                            accmuahan.Email, "Thông báo tại Mintic Logistics.", "Đơn hàng " + o.ID + ", từ: " + orderstatus + ", sang: " + ddlStatus.SelectedItem, "");
                                        }
                                        catch { }
                                    }
                                }
                            ...
                            if (!string.IsNullOrEmpty(comment))
                            {
                                ...
                                if (type == 1)
                                {
                                    if (setNoti != null)
                                    {
                                        ...
                                        //        "Thông báo tại Mintic Logistics.", "Đã có đánh giá mới cho đơn hàng #" + id + " của bạn. CLick vào để xem", "");
                                        //    }
                                        //    catch { }
                                        //}
                                    }
        ...
        protected void btnCurrency_Click(object sender, EventArgs e)
        {
            ...
            if (obj_user != null)
            {
                if (obj_user.RoleID == 0 || obj_user.RoleID == 2 || obj_user.RoleID == 3 || obj_user.RoleID == 6)
                {
                                ...
                                if (listorder != null)
                                {
                                    if (listorder.Count > 0)
                                    {
                                        ...
                                        foreach (var item in listorder)
                                        {
                                            ...
                                            OrderController.UpdateCurrentCNYVN(item.ID, Currency.ToString());
                                        }
                                        pricevnd = Math.Round(pricevnd, 0);
                                        pricecyn = Math.Round(pricecyn, 2);

                                        double servicefee = 0;
                                        if (mo.PercentBuyPro != null)
                                        {
                                            servicefee = Convert.ToDouble(mo.PercentBuyPro);                                            
                                        }
                                        else
                                        {
                                                ...
                                                foreach (var item in adminfeebuypro)
                                                {
                                                    ...
                                                    {                                                       
                                                        if (item.FeePercent.ToString().ToFloat(0) > 0)
                                                            servicefee = Convert.ToDouble(item.FeePercent);                                                       
                                                        break;
                                                    }
                                                }
                                            }                                           

                        ...
                        if (acc.RoleID == 7)
                        {
                            ...
                            if (user_rut != null)
                            {
                                ...
                                if (setNoti != null)
                                {
                                    ...
                                    //            "Thông báo tại Mintic Logistics.", "BQT KÝ GỬI NHANH đã duyệt lệnh rút tiền của bạn.", "");
                                    //    }
                                    //    catch { }
                                    //}
                                }
                    ...
                    else if (status == 3)
                    {
                        ...
                        if (user_rut != null)
                        {
                            ...
                            if (setNoti != null)
                            {
                                ...
                                //    try
                                //    {
                                //        PJUtils.SendMailGmail("monamedia", "uvnajxzzurygsduf", user_rut.Email, "Thông báo tại Mintic Logistics.", "BQT THUẬN ĐẠT EXPRESS đã hủy lệnh rút tiền của bạn.", "");
                                //    }
                                //    catch { }
                                //}
                            }

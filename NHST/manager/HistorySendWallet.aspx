<%@ Page Title="Lịch sử nạp tiền" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="HistorySendWallet.aspx.cs" Inherits="NHST.manager.HistorySendWallet1" %>
            ...
            <div class="page-title">
                <div class="card-panel">
                    ...
                    <div class="right-action">
                        <a class="btn" id="excel-btn" onclick="ExportExcel()" style="background-color: green; margin-right: 10px;">Xuất Excel</a>
                ...
                <div class="rp-detail card-panel row">
                    ...
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            ...
                            <div class="input-field col s12">
                                <asp:TextBox runat="server" placeholder="" ID="pContent" TextMode="MultiLine"
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (data != null) {
                        ...
                        $('#<%=pWallet.ClientID%>').val(data.Amount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (data != "null") {
                        ...
                        html += "   <div class=\"top\">";
                        html += "       <div class=\"left\">";
                       html += "           <span class=\"company-info\">Mintic Logistics</span>";

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report-OrderNew.aspx.cs" MasterPageFile="~/manager/adminMasterNew.Master" Inherits="NHST.manager.Report_OrderNew" %>
                        ...
                        <div class="ad-table-report responsive-tb">
                            <table class="table tb-border  highlight striped   ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Tổng tiền hàng trên Web</td>
                                        <td class="no-wrap">
                                            <div style="justify-content: space-between">
                                                <span class=" font-weight-400">
                                                    <asp:Label ID="lblPriceVND" runat="server"></asp:Label>
                                                </span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tổng tiền chênh lệch</td>
                                        <td class="no-wrap">
                                            <div style="justify-content: space-between">
                                                <span class=" font-weight-400">
                                                    <asp:Label ID="lblFeeHoaHong" runat="server"></asp:Label>
                                                </span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tổng tiền đơn đã mua hàng</td>
                                        <td class="no-wrap">
                                            <div style="justify-content: space-between">
                                                <span class=" font-weight-400">
                                    ...
                                    <tr>
                                        <td>Tổng tiền đơn đã hoàn thành</td>
                                        <td class="no-wrap">
                                            <div style="justify-content: space-between">
                                                <span class=" font-weight-400">

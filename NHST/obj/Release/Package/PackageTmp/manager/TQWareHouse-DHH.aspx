<%@ Page Language="C#" Title="Kiểm kho TQ" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="TQWareHouse-DHH.aspx.cs" Inherits="NHST.manager.TQWareHouse_DHH" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Kiểm hàng Trung Quốc - Đơn hàng hộ</h4>
                </div>
            </div>
    ...
    <script type="text/javascript">
                                        ...
                                        for (var i = 0; i < listSmallpackage.length; i++) {
                                            ...
                                            if (data.OrderTypeInt != 2) {
                                                ...
                                                if (check == false) {
                                                    ...
                                                    html += "<td class=\"size\">";
                                                    html += "<input class=\"packageWeightUpdate\" type=\"number\" value=\"" + data.TotalWeight + "\"></td>";
                                                    html += "<td class=\"size\">";
                                                    html += "<p><span class=\"lb\">d:</span><input class=\"lengthsize\" type=\"number\" value=\"" + data.dai + "\"></p>";
                                                    html += "<p class=\"operator\"><span class=\"lb\">r:</span><input class=\"widthsize\" type=\"number\" value=\"" + data.rong + "\"></p>";
                                                    html += "<p class=\"operator\"><span class=\"lb\">c:</span><input class=\"heightsize\" type=\"number\" value=\"" + data.cao + "\"></p>";
                                                    html += "</td>";
                                              ...
                                              <%--  var selectedbigpack = parseFloat($("#<%=ddlBigpackage.ClientID%> option:selected").val());--%>
                                                    ...
                                                    if (status < 3) {
                                                        ...
                                                        if (status == 0) {
                                                            ...
                                                            html += "<option value=\"1\" selected>Mới đặt chưa về</option>";
                                                        }
                                                        else if (status == 2) {
                                                            html += "<option value=\"2\" selected>Hàng về kho TQ</option>";
                                                        }
                                                    ...
                                                    html += "<a href=\"javascript:;\" onclick=\"printCard('" + data.BarCode + "')\" class=\"tooltipped\" data-position=\"top\" data-tooltip=\"In barcode\"><span class=\"img-barcode bg-barcode\"></span></a>";
                                                ...
                                                if (data.OrderTypeInt != 1) {
                                                    ...
                                                    if (check == false) {
                                                        ...
                                                        html += "</thead>";
                                                        html += "<tbody class=\"orderid" + UID + " dh" + data.MainorderID + "\" data-orderid=\"" + data.MainorderID + "\"  data-ordertype=\"" + data.OrderTypeInt + "\">";
                                                        html += "<tr><td rowspan=\"10\" class=\"grey lighten-2\"><a href=\"/manager/transportationdetail.aspx?id=" + data.TransportationID + "\" target=\"_blank\">" + data.TransportationID + "</a></td></tr>";
                                                        if (data.Status == 0) {
                                                            html += "<tr class=\"package-row isvekho slide-up lighten-4 order-id  " + data.MainorderID + " small" + UID + "\" data-packageID=\"" + packageID + "\" id=\"" + packageID + "\" data-barcode=" + data.BarCode + ">";
                                                        }
                                                        else if (data.Status == 1) {
                                              ...
                                              <%--  var selectedbigpack = parseFloat($("#<%=ddlBigpackage.ClientID%> option:selected").val());--%>
                                                        ...
                                                        if (status < 3) {
                                                            ...
                                                            if (status == 0) {
                                                                ...
                                                                html += "<option value=\"1\" selected>Đơn hàng mới</option>";
                                                            }
                                                            else if (status == 2) {
                                                                html += "<option value=\"2\" selected>Hàng về kho TQ</option>";
                                                            }
                                                                ...
                                                                html += "<option value=\"4\" selected>Hoàn thành đơn</option>";
                                                            }
                                                        }
                                                ...
                                                //alert('Kiện này thuộc đơn hàng ký gửi, vui lòng sang trang kiểm kho TQ - đơn hàng ký gửi.');
                                            }
                                        }
                                    }
        ...
        function printCard(barcode) {
            ...
            $.ajax({
                type: "POST",
                url: "/manager/TQWareHouse-DHH.aspx/PriceCard",
                data: "{barcode:'" + barcode + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
